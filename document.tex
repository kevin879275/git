...
　　現今的社會中，多數人都會經常對著手機跟電腦，逛社群軟體、網拍、玩遊戲等等，變得不常接觸有生命的東西，每天都會只對著螢幕來了解社會正在發生的問題，但沒有發現一個重要的事情，平常生活在我們身邊的毛孩子是狗還是貓。\\
	\\
　　所以我們撰寫了一個可以分貓跟狗的程式，方便那些不太能辨認動物的飼主來了解自己身邊的毛小孩，只要上傳自己身邊動物的照片，系統便可以幫助飼主判斷所養的是狗或是貓。\\
	\\
　　這個系統在未來我相信會站到很重要的位子，假使寵物狗走失，巷口的監視器便可以幫忙過濾動物的樣子，不用去用人眼判斷經過的是貓或是狗，得到狗的樣子再來進一步搜尋，可以大大減少找動物的時間。\\
